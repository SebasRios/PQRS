...
@NamedQueries({
    ...
    @NamedQuery(name = "Personal.findByCodigoDepartamento", query = "SELECT p FROM Personal p WHERE p.codigoDepartamento = :codigoDepartamento")})
public class Personal implements Serializable {
    ...
    public Personal(PersonalPK personalPK, String nombres, String apellidos, String telefono, String correoElectronico, String contraseña, String codigoDepartamento) {
        this.personalPK = personalPK;
    ...
    public String toString() {
        return "com.airline.modelo.Personal[ personalPK=" + personalPK + " ]";
    }
